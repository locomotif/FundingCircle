...
/**
 * PrimeMultiplicationSuite.php
 *
 * A basic test suite to accomplish TDD of the Prime Package, and utility class.
 * The reason for coding a basic test suite was to avoid having to implement
 * dependencies, such as PHPUnit
 *
 * The main.php function executes these tests by targeting any method that
 * starts with "test_". To by pass any test just rename the prefix of any
 * method that starts with "test_" to "ignore_", but any difference will do.
 *
 * I opted not to use PHP assertion methods, in order to add some color to the
 * results.
 */
...
class PrimeMultiplicationSuite implements TestSuite 
{
    ...
    /**
     * this test just ensures that I am getting the min and maxs for a small range.
     * test should succeed in 1000 attempts
     */
    ...
    /**
     * simple custom assertion to format results
     */
    public function assertion($bool, $name, $desc = "")
    {
        if ($bool) {
